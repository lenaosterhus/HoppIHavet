...
sealed class Badested(
    ...
    object Bekkensten:      Badested("59.791851", "10.731905", "Bekkensten", "Bekkensten er en populær badeplass i Svartskog. Stor gresslette ovenfor badeplassen. Liten sandstrand med noe småstein. Svaberg.\n" + "Nyoppussede toaletter våren 2010")
    object Bestemorstranda: Badested("59.827157", "10.759095", "Bestemorstanda", "Bestemorstranda er den første badeplassen du kommer til langs Ingierstrandveien. Her finner du en enkel badeplass med en liten sandstrand og svaberg.\n" + "Brygga på Bestemorstranda er en populær fiskeplass.")
    object BygdoySjobad:    Badested("59.908739", "10.663209", "Bygdøy Sjøbad", "Området ble rehabilitert av Statsbygg i 2008 og framstår i dag som et meget fint sted med en fin sandstrand.\n" + "Badestranda ligger ganske langt inn i Bestumkilen, på vestsiden av Bøgdøy.")
    object Fiskevollbukta:  Badested("59.842146", "10.773534", "Fiskevollbukta", "Fiskevollbukta har en liten vestvendt sandstrand og svaberg. Mye kveldssol. En del skjell og steiner på stranda og ute i vannet.")
    object Gressholmen:     Badested("59.883348", "10.724997", "Gressholmen", "Gressholmen tilbyr bademuligheter en kort båttur fra Rådhuskaia i Oslo sentrum.\n" + "Flere små bukter og områder med grov sand og ruglete svaberg.\n" + "Mat og drikke får du på Gressholmen kro.")
    object Rambergoya:      Badested("59.878858", "10.714658", "Rambergøya", "Flere bademuligheter på sørsiden av Rambergøya.\n" + "Rambergøya henger sammen med Gressholmen med en steinfylling.")
    object Hvervenbukta:    Badested("59.833008", "10.771047", "Hvervenbukta", "Det er to fine sandstrender, svaberg og gressbakker hvor man kan nyte sommersolen til langt på kvelden.\n" + "Fin baderampe for bevegelseshemmede.\n" + "Toalettene er nyoppusset våren 2010.")
